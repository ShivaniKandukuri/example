...
class ConsumersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create consumer" do
    assert_difference('Consumer.count') do
      post consumers_url, params: { consumer: { name: @consumer.name, role: @consumer.role } }, as: :json
    end
  ...
  test "should update consumer" do
    patch consumer_url(@consumer), params: { consumer: { name: @consumer.name, role: @consumer.role } }, as: :json
    assert_response 200
  end
